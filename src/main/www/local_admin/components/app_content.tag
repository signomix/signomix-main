<app_content>
    <main>
        ...
        <div  class="container-fluid topspacing" if={ app.currentPage=='system'}><app_system></app_system></div>
        <div  class="container-fluid topspacing" if={ app.currentPage=='account'}><app_account></app_accpunt></div>
