        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-primary fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"  data-toggle="collapse" data-target="#navbarNavDropdown" onclick="document.location = '#system';" if={app.user.status == 'logged-in' && app.user.role.includes('admin')}>
                        <a class="nav-link" href="#system">{ app.texts.app_header.system[app.language] }</a>
                    </li>
                    <li class="nav-item"  data-toggle="collapse" data-target="#navbarNavDropdown" onclick="document.location = '#account';" if={app.user.status == 'logged-in' && app.user.role.includes('admin')}>
                        <a class="nav-link" href="#account">{ app.texts.app_header.account[app.language] }</a>
                    </li>
                    ...
                    <li class="nav-item" data-toggle="collapse" data-target="#navbarNavDropdown" onclick="document.location = '#fr';" if={app.language!='fr'}><a class="nav-link" href="#fr">FR</a></li>
