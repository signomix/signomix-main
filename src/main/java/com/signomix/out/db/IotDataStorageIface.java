...
public interface IotDataStorageIface extends KeyValueDBIface {
    ...
    public List<List<List>> getValuesOfGroup(String userID, long organizationID, String groupEUI, String[] channelNames, long interval, String dataQuery) throws ThingsDataException;
